...
const { getBroadcastMessages,getBroadcastUsers,markBroadcastDone, markInactive, markSecondInactive } = require('../controllers/bot/broadcastController');
...
router.post('/bot-user/mark-second-inactive',markSecondInactive)
